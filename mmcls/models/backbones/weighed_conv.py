...
from mmcls.models.utils import Dynamic_Conv2D

eps = 1.0e-5


class DynamicBasicBlock(_BasicBlock):
...
class DynamicBottleneck(_Bottleneck):
    ...
    def __init__(
        ...
        # )
        self.conv1 = Dynamic_Conv2D(
            in_channels, self.mid_channels, 1, stride=self.conv1_stride, bias=False
        )
        self.add_module(self.norm1_name, norm1)
        # self.conv2 = build_conv_layer(
        #     conv_cfg,
        ...
        # )
        self.conv3 = Dynamic_Conv2D(self.mid_channels, out_channels, 1, bias=False)
...
class Dynamic_Resnet_cifar(ResNet):
    ...
    arch_settings = {
        18: (DynamicBasicBlock, (2, 2, 2, 2)),
        34: (DynamicBasicBlock, (3, 4, 6, 3)),
        50: (DynamicBottleneck, (3, 4, 6, 3)),
        101: (DynamicBottleneck, (3, 4, 23, 3)),
        152: (DynamicBottleneck, (3, 8, 36, 3)),
    }

    def __init__(self, depth, deep_stem=False, **kwargs):
        super(Dynamic_Resnet_cifar, self).__init__(depth, deep_stem=deep_stem, **kwargs)
...
@BACKBONES.register_module()
class Dynamic_Resnet_imagenet(ResNet):
    """Eca_Resnet_cifar backbone for CIFAR.
    ...
    def __init__(self, depth, deep_stem=False, **kwargs):
        super(Dynamic_Resnet_imagenet, self).__init__(
